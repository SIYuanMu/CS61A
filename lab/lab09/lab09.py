...
def reverse_other(t):
    ...
    n = len(branches)
    for i in range(n//2):
        branches[i].label, branches[n-i-1].label = branches[n-1-i].label, branches[i].label
    """ 
    for b in t.branches:
    ...
    second_branches = []
    for b in branches:
        second_branches += b.branches
    # map(reverse_other, second_branches)
    for elem in second_branches:
        reverse_other(elem)
